...
for i = 1:nPktL
    ...
    midtMomEnde = (1/L)*((fim(i,1)*b) + fim(i,2)*a); 

    % Det totale momentet på midten n 
    BoyPktL(element,1) = BoyPktL(element,1) + m + midtMomEnde;
end

fprintf('Bøyemoment under punktlaster regnet ut\n')
end
